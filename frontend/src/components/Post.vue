    ...
    >
      <div class="d-flex align-items-center">
        <div class="d-flex mr-3">
          <router-link to="/profil" class="container_user bg-white" params: { userId: post.User.id } >
        ...
        <div class="text-left">
          <router-link to="/profil" , params: { userId: post.User.id }
      ...
      <b-card-text class="text-left mt-3 mb-0 mb-lg-3" v-if="post.title">
        {{ post.title }}
      </b-card-text>
